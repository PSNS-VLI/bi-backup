...
const checkboxContentDefault = ['percent']
...
export const chartConfig = defineChartConfig({
  ...
  styles: defineStyles({ componentName }, [
    ...
    defineCollapse({
      ...
      switcherKey: chartConfigKey.dataTagSwitchKey
    }),
    defineCollapse({
...
export default defineChart(chartConfig, {
  id: componentID,
  icon: 'icon-Chart_Percentage',
  name: componentName,
  description: '在堆积面积图的基础上，将各个面积的因变量的数据累加并对总量进行归一化。',
  dimensionDescription: '最少1个维度',
  measureDescription: '最少1个个度量',
